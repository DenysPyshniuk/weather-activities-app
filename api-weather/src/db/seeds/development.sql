...
VALUES 
  ('Clear','Social',40,20,'Paint Fight','Fill up balloons with (hopefully non-toxic) paint and have a war.'),
  ('Clear','Leisure',40,20,'No Pool? No Problem','Cover a trampoline in water and soap, then slide around on it.'),
  ('Clear','Nature',40,20,'Visit the Zoo','Go to the zoo and try to guess what all the animals are thinking about.'),
  ('Clear','Buy/Sell',40,20,'Have a Yard Sale','Gather all your old stuff together and have a yard sale. Then split the profits and spend it all on ice cream or something.'),
  ('Clouds','Leisure',25,20,'Go to a Park', 'Go to the playground at a park and swing on the swings, as long as you are still young enough for that to not be creepy.'),
  ('Clouds','Social',25,20,'Pool Party!','Have a pool party without a pool. Everyone can just sit in the living room with swim suits and goggles.'),
  ('Clouds','Event',25,20,'Celebrate Something','Have a parade with just you walking down the street playing a kazoo. Maybe have your dog in there too.'),
  ('Clouds','Social',25,20,'Pac-Tag','Dress as Pac-Man, get 4 friends dressed up as ghosts, and play tag in a public place.'),
